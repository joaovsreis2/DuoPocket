...
class DuoGba {
  constructor(rom, save) { this.memory = new GbaMemory(rom, save); this.cpu = new Arm7tdmi(this.memory); this.ppu = new GbaPpu(this.memory); this.frameCycles = 280896; this.paused = false; }
